        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center space-x-3 mb-4 group">
              ...
              <span className="text-xl font-bold bg-gradient-to-r from-[#16BDCA] via-[#0EA5E9] to-[#16BDCA] bg-clip-text text-transparent font-display">MetaCodr</span>
            </Link>
            <p className="text-gray-400 mb-4">
              Empowering businesses to scale, innovate, and thrive with future-ready AI & IT solutions.
            </p>
            <div className="flex space-x-4">
              <a href="https://linkedin.com/company/metacodr" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-neural-cyan transition-all hover:scale-110">
                <Linkedin className="w-5 h-5" />
              </a>
              <a href="https://twitter.com/metacodr" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-neural-cyan transition-all hover:scale-110">
                <Twitter className="w-5 h-5" />
              </a>
              <a href="https://github.com/metacodr" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-neural-cyan transition-all hover:scale-110">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3 text-gray-400 group">
                ...
                <a href="mailto:contact@metacodr.com" className="hover:text-neural-cyan transition-colors">
